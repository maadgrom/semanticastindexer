...
- [Search and duplicates](guides/search-and-duplicates.md)
- [Keeping the index in sync](guides/keeping-in-sync.md)
...
- [Opt-out markers](guides/opt-out-markers.md)

# Reference

- [CLI](reference/cli.md)
- [Configuration](reference/configuration.md)
- [MCP server and tools](reference/mcp-server.md)
...
- [Performance and scaling](operations/performance.md)
